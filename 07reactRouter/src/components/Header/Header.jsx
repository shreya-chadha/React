...
//In react, anchor tag is not used as it reloads the entire page so Link is used in place of it.
// React also provides Navlink with some additional features like highlighting the active new page.
